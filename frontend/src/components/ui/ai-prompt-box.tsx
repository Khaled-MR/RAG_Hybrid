      ...
      >
        ...
        <PromptInputActions className="flex items-center justify-between gap-2 p-0 pt-2">
          ...
          >
            ...
            {/* Search / Think / Canvas toggles removed — they corrupted the
                RAG question (wrapping it as "[Think: ...]") and broke language
                detection. Not applicable to a document Q&A app. */}
          </div>
